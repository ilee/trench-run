...
var loadWorld = function() {
	...
	function drawLightingHelper()
	{
		...
		*/
		...
		dirlightbulb.position.set(500, 20, -1000);
		...
		dirlightbulb2.position.set(100, -200, -500);
...
var createPlayer = function(data){
    ...
    loader.load( "textures/xwing.dae", function( collada ) {
		...
		// player.rotation.set(Math.PI*1.5, Math.PI*2, Math.PI / 2);
...
var checkKeyStates = function(){
    ...
    if (keyState[40] || keyState[83]) {
        ...
        // player.position.y -= moveSpeed * Math.sin(player.rotation.y); // height
        player.position.z += moveSpeed; // depth
        updatePlayerData();
        socket.emit('updatePosition', playerData);
    }
...
var addOtherPlayer = function(data){
    ...
    loader.load( "textures/xwing.dae", function( collada ) {
		...
		otherPlayer.traverse( function ( child ) {
